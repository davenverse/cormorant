...
trait LabelledWriteProofs extends LowPriorityLabelledWriteProofs {
   ...
   */
  implicit def labelledWriteHNilPut[K <: Symbol, H](implicit
...
private[internal] trait LowPriorityLabelledWriteProofs extends LowPriorityLabelledWriteProofs1 {
   ...
   * as
   */
  implicit def deriveByNameHListPut[K <: Symbol, H, T <: HList](implicit
      witness: Witness.Aux[K],
      P: Put[H],
...
private[internal] trait LowPriorityLabelledWriteProofs1 extends LowPriorityLabelledWriteProofs2 {
  implicit def deriveByLabelledWrite2[K, H, T <: HList](implicit
      P: LabelledWrite[H],
      labelledWrite: Lazy[LabelledWrite[T]]
  ): LabelledWrite[FieldType[K, H] :: T] =
    new LabelledWrite[FieldType[K, H] :: T] {
...
private[internal] trait LowPriorityLabelledWriteProofs2 {
  implicit def labelledWriteHNilGet[K, H](implicit
      W: LabelledWrite[H]
  ): LabelledWrite[FieldType[K, H] :: HNil] =
    new LabelledWrite[FieldType[K, H] :: HNil] {
      def headers: CSV.Headers =
