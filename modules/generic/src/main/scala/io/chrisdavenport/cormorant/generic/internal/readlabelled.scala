...
private[internal] trait LowPriorityLabelledReadProofs extends LowPriorityLabelledReadProofs1 {
  ...
  implicit def deriveLabelledReadHList[K <: Symbol, H, T <: HList](implicit
...
private[internal] trait LowPriorityLabelledReadProofs1 extends LowPriorityLabelledReadProofs2 {
  implicit def deriveLabelledRead2[H, T <: HList](implicit
      P: LabelledRead[H],
      labelledRead: Lazy[LabelledRead[T]]
...
private[internal] trait LowPriorityLabelledReadProofs2 {
  implicit def deriveLabelledRead3[K <: Symbol, H, T <: HList](implicit
      P: LabelledRead[H],
      labelledRead: Lazy[LabelledRead[T]]
  ): LabelledRead[FieldType[K, H] :: T] = new LabelledRead[FieldType[K, H] :: T] {
